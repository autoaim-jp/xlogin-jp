export const handleConnectWithoutUser = ({ debugLog, core, TEST_PARAM, EXPECTED_PARAM }) => {
  return async () => {
    const expected = {
      status: 1,
...
export const handleConnectWithUser = ({ debugLog, core, TEST_PARAM, EXPECTED_PARAM }) => {
  return async () => {
    const expected = {
      status: 1,
      session: EXPECTED_PARAM.session,
