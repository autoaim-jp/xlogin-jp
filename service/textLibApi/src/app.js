...
const _getFunctionRouter = () => {
  ...
  const parseTextHandler = a.action.getHandlerParseText({
    handleParseText: a.core.handleParseText,
  })
  expressRouter.post(`/api/${a.setting.getValue('url.API_VERSION')}/text-lib/parse`, checkSignature, parseTextHandler)
