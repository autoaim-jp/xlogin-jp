...
===== maybe you need make func exported like  module.exports = { func, } =====`);
  ...
  var getOnSubmitLogin = /* @__PURE__ */ __name(({
  ...
  var getPostLogin = /* @__PURE__ */ __name(({ apiEndpoint: apiEndpoint2, postRequest: postRequest2 }) => {
  ...
  var getLoginFormElm = /* @__PURE__ */ __name(() => {
  ...
  var setLoginFormSubmit = /* @__PURE__ */ __name(({ onSubmitLogin }) => {
  ...
  var a = asocial;
  var loadLoginForm = /* @__PURE__ */ __name(() => {
