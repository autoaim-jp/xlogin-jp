...
===== maybe you need make func exported like  module.exports = { func, } =====`);
    ...
    var _convertScopeToLabel = ({
        ...
        const {
            label: labelPart,
            summary
        } = labelList2.scopeBody[paramList[1]][paramList[2]];
    ...
    var convertPermissionList = ({
        ...
        scopeList.forEach((scope) => {
            permissionLabelList[scope] = _convertScopeToLabel({
                scope,
                labelList: labelList2
            });
        });
    ...
    var setOnCheckAllScopeButton = ({
        onClickCheckAllScopeButton
    }) => {
