...
init-xdevkit:
	...
	cp ./xdevkit-backend/common/xdevkit-setting/browserServerSetting.js ./staticWeb/view/src/js/_setting/browserServerSetting.js
	cp ./xdevkit-backend/common/xdevkit-setting/browserServerSetting.js ./staticWeb/setting/browserServerSetting.js
	cp ./xdevkit-backend/common/xdevkit-setting/browserServerSetting.js ./authApi/setting/browserServerSetting.js
	cp ./xdevkit-backend/common/xdevkit-setting/browserServerSetting.js ./storageApi/setting/browserServerSetting.js
	...
	cp -r ./xdevkit-backend/common/xdevkit-view-component/src/js/_xdevkit ./staticWeb/view/src/js/_lib/
 
init-common:
	mkdir -p ./service/authApi/lib/ && cp ./xdevkit-backend/common/backend-server/lib.js ./service/authApi/lib/backendServerLib.js
	mkdir -p ./service/storageApi/lib/ && cp ./xdevkit-backend/common/backend-server/lib.js ./service/storageApi/lib/backendServerLib.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/authApi/lib/backendServerLib.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/storageApi/lib/backendServerLib.js
	mkdir -p ./service/authApi/input/ && cp ./xdevkit-backend/common/backend-server/input.js ./service/authApi/input/backendServerInput.js
	mkdir -p ./service/storageApi/input/ && cp ./xdevkit-backend/common/backend-server/input.js ./service/storageApi/input/backendServerInput.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/authApi/input/backendServerInput.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/storageApi/input/backendServerInput.js
	mkdir -p ./service/authApi/output/ && cp ./xdevkit-backend/common/backend-server/output.js ./service/authApi/output/backendServerOutput.js
	mkdir -p ./service/storageApi/output/ && cp ./xdevkit-backend/common/backend-server/output.js ./service/storageApi/output/backendServerOutput.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/authApi/output/backendServerOutput.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/storageApi/output/backendServerOutput.js
	mkdir -p ./service/authApi/core/ && cp ./xdevkit-backend/common/backend-server/core.js ./service/authApi/core/backendServerCore.js
	mkdir -p ./service/storageApi/core/ && cp ./xdevkit-backend/common/backend-server/core.js ./service/storageApi/core/backendServerCore.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/authApi/core/backendServerCore.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' ./service/storageApi/core/backendServerCore.js
	@sleep 1
