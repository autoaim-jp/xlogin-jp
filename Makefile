...
init-common:
	mkdir -p authApi/lib/ && cp common/backend-server/lib.js authApi/lib/commonServerLib.js
	mkdir -p storageApi/lib/ && cp common/backend-server/lib.js storageApi/lib/commonServerLib.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' authApi/lib/commonServerLib.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' storageApi/lib/commonServerLib.js
