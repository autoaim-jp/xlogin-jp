...
init-common:
	mkdir -p staticWeb/lib/ && cp common/server/lib.js staticWeb/lib/commonServerLib.js
	mkdir -p authApi/lib/ && cp common/server/lib.js authApi/lib/commonServerLib.js
	mkdir -p storageApi/lib/ && cp common/server/lib.js storageApi/lib/commonServerLib.js
	sed -i '1s/^/\/* DO NOT EDIT THIS FILE. *\/\n/' staticWeb/lib/commonServerLib.js
